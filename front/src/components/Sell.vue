...
const more = (product: Product) => {
    product.stock++;
    product.ogstock++;
    store.dispatch('updateProductBE', product);
};
...
const edit = (editedProduct: Product) => {
    if (imageFile.value != null)
        editedProduct.image = imageFile.value;
    ...
    store.dispatch('updateProductBE', editedProduct);
    closeEditModal();
};
        ...
        <div class="modal-card p-3" v-if="editedProduct">
            ...
            <section class="modal-card-body">
                ...
                <div class="field">
                    ...
                    <div class="control has-icons-left">
                        <input v-model="editedProduct.price" class="input" type="number" min="1" placeholder="100" required>
                        <span class="icon is-small is-left">
